...
public class Admin {
	...
	static void createAdminCommands() {
		 ...
		 * IMessage message = ch.getPinnedMessages().get(0); IEmbed embed =
		 * message.getEmbeds().get(0); System.out.println(embed.getTitle());
		 * System.out.println(embed.getDescription()); }; Handler.commandMap.put("test",
		 * test);
		 */
	}
